...
// 1010monky admin — moduler. Översikt är landningssidan; resten byggs en i taget
// (badge "Snart" = ännu inte byggd, href "#"). GA-modulen tänds när property-data
// och service-konto finns. Behåll keys i synk med varje sidas data-page.
export const NAV = [
  {
    label: 'Översikt',
    items: [
      { key: 'oversikt', href: '/admin',        text: 'Översikt',     icon: 'dashboard' },
      { key: 'trafik',   href: '#',             text: 'Trafik & SEO', icon: 'charts', badge: { text: 'GA', cls: 'badge-blue' } }
    ]
  },
  {
    label: 'Kunder & affärer',
    items: [
      { key: 'leads',   href: '/admin/leads',    text: 'Leads',    icon: 'users' },
      { key: 'inkorg',  href: '/admin/inkorg',   text: 'Inkorg',   icon: 'chat' },
      { key: 'offert',  href: '/admin/offerter', text: 'Offerter', icon: 'receipt' },
      { key: 'projekt', href: '/admin/projekt', text: 'Projekt',  icon: 'projects' }
    ]
  },
  {
    label: 'Ekonomi',
    items: [
      { key: 'intakter',    href: '/admin/intakter',    text: 'Intäkter',    icon: 'price' },
      { key: 'forkalkyl',   href: '/admin/forkalkyl',   text: 'Förkalkyl',   icon: 'forms' },
      { key: 'efterkalkyl', href: '/admin/efterkalkyl', text: 'Efterkalkyl', icon: 'tables' }
    ]
  },
  {
    label: 'Konto',
    items: [
      { key: 'installningar', href: '/admin/installningar', text: 'Inställningar', icon: 'settings' }
    ]
  }
];
  ...
  return `
    <aside class="sidebar" aria-label="Primary navigation">
      <div class="sidebar-brand">
        ...
        <div class="brand-name">1010monky <small>studio</small></div>
      </div>
      <nav class="sidebar-nav">${groups}</nav>
      <div class="sidebar-footer">
        <div class="sidebar-user">
          <div class="avatar">M<span class="online"></span></div>
          <div class="sidebar-user-info">
            <div class="name">Matias</div>
            <div class="role">1010monky studio</div>
          </div>
...
export function renderFooter() {
  return `
    <footer class="footer">
      <span>1010monky studio · adminpanel</span>
      <span>2026</span>
    </footer>
  `;
}
