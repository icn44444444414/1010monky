...
function buildItems() {
  ...
  // Inline actions
  const actions = [
    { label: 'Växla tema', keywords: 'tema mörkt ljust theme dark light toggle', action: toggleTheme },
    { label: 'Inställningar', keywords: 'inställningar konto lösenord settings', action: () => { window.location.href = '/admin/installningar'; } },
    { label: 'Logga ut', keywords: 'logga ut sign out logout exit', action: () => { window.location.href = '/admin/logout'; } }
  ];
